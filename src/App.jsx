            ...
            <div className="bg-zinc-900 rounded-2xl border border-zinc-700 overflow-hidden shadow-2xl">
              {getYouTubeId(randomClip.url) && (
                <a href={buildTimestampUrl(randomClip)} target="_blank" rel="noopener noreferrer" className="block relative aspect-video bg-zinc-800 group">
                  ...
                  />
                  <div className="thumb-placeholder absolute inset-0 flex-col items-center justify-center bg-gradient-to-br from-zinc-800 to-zinc-900" style={{ display: 'none' }}>
                    <div className="text-5xl mb-2">🎬</div>
                    <div className="text-zinc-400 text-sm text-center px-4 font-medium uppercase tracking-wide">{randomClip.title.split(' - ')[0]}</div>
                  </div>
                  ...
                  {videoId && (
                    <a href={buildTimestampUrl(clip)} target="_blank" rel="noopener noreferrer" className="block relative bg-zinc-800" style={{ aspectRatio: '16/10' }}>
                      ...
                      <div className="thumb-placeholder absolute inset-0 flex-col items-center justify-center bg-gradient-to-br from-zinc-800 to-zinc-900" style={{ display: 'none' }}>
                        ...
                        <div className="text-zinc-400 text-[10px] text-center px-2 font-medium uppercase tracking-wide leading-tight">{clip.title.split(' - ')[0]}</div>
                      </div>
